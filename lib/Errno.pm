...
"MSWin32-x64-multi-thread-6.2" or
	die "Errno architecture (MSWin32-x64-multi-thread-6.2) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
